...
> **Antes de publicar un dominio real**: actualizá `site` en `astro.config.mjs` (hoy apunta a `https://mundo-gamer.example.com` como placeholder) para que canonical, sitemap, Open Graph y JSON-LD usen la URL real.